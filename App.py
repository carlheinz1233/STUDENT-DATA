...
def first_year_user():
    ...
    def view_entries(event):
        ...
        if selected_option == '1st Sem':
            ...
            cursor.execute("SELECT SubjectName, SubjectDescription, CreditsUnits, Grades, Remarks FROM First_Sem")
            ...
            cursor.execute("SELECT SubjectName, SubjectDescription, CreditsUnits, Grades, Remarks FROM Second_Sem")
    ...
    def save_table_data():
        ...
        if yearlevel:
            ...
            for row_fields in input_fields:
                ...
                if SubjectName and SubjectDescription and CreditsUnits and Grades and Remarks:
